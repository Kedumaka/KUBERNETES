# KUBERNETES (Creating master and worker nodes)
#Kube-Master(Controller)  - VM 			# Ubuntu v22.04 - t2.micro instance type 
#	Kube-Worker1
#	Kube-Worker2


#Need to create inbound rules and add all the ports below:
...
kubeadm join 172.31.11.255:6443 --token b032hx.0y73mgwpnkfon2qy \
        --discovery-token-ca-cert-hash sha256:ea8f2ad90bd059c3c2d5eb252cb228d7234baa27f7f5b865967fbba9ed2390a1
